        ...
        <>
            <div class="px-10 max-md:px-2">
                <div className=" h-32 max-sm:h-24  flex flex-col justify-center items-center">
                    ...
                    <p className='py-2 px-3'>Home / Privacy Policy</p>
                </div>
                <p className='py-2 px-3'>Last updated: March 09, 2023</p>
                ...
                <h4 className='text-3xl font-bold py-3'>Interpretation</h4>
                <p className='py-2 px-3'>
                ...
                <h4 className='text-3xl font-bold py-3'>Definitions</h4>
                <p className='py-2 px-3'>For the purposes of this Privacy Policy:</p>
                <ul className='list-disc ml-16 text-sm'>
                    <li className=''>
                        <p className='py-1'>
                    ...
                    <li className=''>
                        <p className='py-1'>
                            ...
                            refers to Blueskytech, 268 St, South New York/NY
                            98944, United States..
                        </p>
                    </li>
                    <li className=''>
                    ...
                    <li className=''>
                        <p className='py-1'>
                            <strong>Website</strong> refers to Umino, accessible
                            from{" "}
                            <a
                                href="https://blueskytechmage.com/gota/"
                                rel="external nofollow noopener noreferrer"
                                target="_blank"
                            >
                                https://blueskytechmage.com/gota/
                            </a>
                        </p>
                    </li>
                    <li className=''>
                ...
                <h4 className='text-3xl font-bold py-3'>Personal Data</h4>
                <p className='py-2 px-3'>
                ...
                <ul className='list-disc ml-16 text-sm'>
                    ...
                    <li className=''>
                        <p className='py-1'>Address, State, Province, ZIP/Postal code, City</p>
                    </li>
                    <li className=''>
                        <p className='py-1'>Usage Data</p>
                    </li>
                </ul>
                <h4 className='text-3xl font-bold py-3'>Usage Data</h4>
                <p className='py-2 px-3'>
                ...
                <h4 className='text-3xl font-bold py-3'>Tracking Technologies and Cookies</h4>
                <p className='py-2 px-3'>
                ...
                <ul className='list-disc ml-16 text-sm'>
                    <li className=''>
                        ...
                        <p className='py-2 px-3'>Type: Session Cookies</p>
                        <p className='py-2 px-3'>Administered by: Us</p>
                        <p className='py-2 px-3'>
                    ...
                    <li className=''>
                        ...
                        <p className='py-2 px-3'>Type: Persistent Cookies</p>
                        <p className='py-2 px-3'>Administered by: Us</p>
                        <p className='py-2 px-3'>
                ...
                <h4 className='text-3xl font-bold py-3'>Use of Your Personal Data</h4>
                <p className='py-2 px-3'>
                ...
                <h4 className='text-3xl font-bold py-3'>Retention of Your Personal Data</h4>
                <p className='py-2 px-3'>
                ...
                <h4 className='text-3xl font-bold py-3'>Transfer of Your Personal Data</h4>
                <p className='py-2 px-3'>
                ...
                <h4 className='text-3xl font-bold py-3'>Delete Your Personal Data</h4>
                <p className='py-2 px-3'>
                ...
                <h4 className='text-3xl font-bold py-3'>Disclosure of Your Personal Data</h4>
                <h4 className='text-3xl font-bold py-3'>Business Transactions</h4>
                <p className='py-2 px-3'>
                ...
                <h4 className='text-3xl font-bold py-3'>Law enforcement</h4>
                <p className='py-2 px-3'>
                ...
                <h4 className='text-3xl font-bold py-3'>Other legal requirements</h4>
                <p className='py-2 px-3'>
                    The Company may disclose Your Personal Data in the good
                    faith belief that such action is necessary to:
                </p>
                <ul className='list-disc ml-16 text-sm'>
                    <li className='px-5'>Comply with a legal obligation</li>
                    <li className='px-5'>
                    ...
                    <li className='px-5'>Protect against legal liability</li>
                </ul>
                <h4 className='text-3xl font-bold py-3'>Security of Your Personal Data</h4>
                <p className='py-2 px-3'>
                ...
                <h4 className='text-3xl font-bold py-3'>Children's Privacy</h4>
                <p className='py-2 px-3'>
                ...
                <h4 className='text-3xl font-bold py-3'>Links to Other Websites</h4>
                <p className='py-2 px-3'>
                ...
                <h4 className='text-3xl font-bold py-3'>Changes to this Privacy Policy</h4>
                <p className='py-2 px-3'>
                ...
                <ul className='list-disc ml-16 text-sm'>
                    <li className='px-5'>By email: demo.umino@gmail.com</li>
                </ul>
            </div>
        </>
    );
